...
The public buildable source and evidence release is available at:
\begin{center}
\small\url{https://github.com/inlanger/esp32-p4-inflect-tts}
\end{center}
The original paper-only snapshot is commit
\nolinkurl{336e7670a4e6a540d8841df35f8d9b3da3fae23f}. Its exact URL is:
\begin{center}
\small\url{https://github.com/inlanger/esp32-p4-inflect-tts/commit/336e7670a4e6a540d8841df35f8d9b3da3fae23f}
\end{center}
The exact no-retraining firmware and artifact release is commit
\nolinkurl{f5701f9f92e92522086233d6c10879c07740b10f}. Supplemental sanitized
decoder evidence was added in commit
\nolinkurl{d73897194ae034cf8a13d87add01ca15f99799f8}.

The deployable ESP-DL model package is distributed separately at:
\begin{center}
\small\url{https://huggingface.co/inlanger/inflect-nano-v2-esp32p4-espdl}
\end{center}
Its immutable Hub revision is
\nolinkurl{282a7eaf953e8a9e972b86d844d1d2823a48df21}. The Hub repository contains
only model packages, fixed assets, a retained WAV, the model card, manifest,
and model-license notices. Firmware, the ESP-DL patch, raw JSON telemetry,
build scripts, and supplemental analysis remain in the GitHub repository.
Experimental retrained G5--G18 decoder lineages are excluded from both
releases.

The final main package is named \texttt{short64-flow48}; it contains the
acoustic graph, T64 and T96 waveform decoders, and the CSE Flow48 graph. Its size is
...
The public supplemental record at
\nolinkurl{evidence/decoder-surface/decoder-surface.json} contains every
decoder convolution shape, nominal MAC count, real activation statistics,
parameter group, and receptive-field result. Only two workstation-local paths
were removed from the retained research record; all numeric evidence and
source hashes are unchanged. Its public SHA-256 is
\nolinkurl{ad3fe556db6ea0ca54115ad7413ff1d7a88d7df18ef0f1c81e26419180c254bb}.
...
several-board replication, controlled listener ratings, power measurements,
I2S playback, and comparisons against at least one purpose-built MCU vocoder.
Achieving faster-than-real-time generation with a trained causal or spectral
decoder would constitute a separate model result.
